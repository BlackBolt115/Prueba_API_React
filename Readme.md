...
To get stated clone project and install dependencies. Then:
...
-   Connect to the Marketplace API with help from the provided documentation (No authentication needed for this exercise) 
